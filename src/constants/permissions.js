...
export const PERMISSIONS = {
  // Dashboard
  VIEW_DASHBOARD: [ROLES.SUPER_ADMIN, ROLES.ADMIN, ROLES.DIRECCION, ROLES.ANALISTA, ROLES.VALIDADOR_C3, ROLES.DEPENDENCIA, ROLES.OPERADOR_CCP],
  VIEW_PANEL_DIRECCION: [ROLES.SUPER_ADMIN, ROLES.ADMIN, ROLES.DIRECCION],
  ...
  // Trámites - Baja
  VIEW_BAJA: [ROLES.SUPER_ADMIN, ROLES.ADMIN, ROLES.ANALISTA],
  CREATE_BAJA: [ROLES.SUPER_ADMIN, ROLES.ADMIN, ROLES.ANALISTA],
  
  // Consultas
  VIEW_CONSULTA: [ROLES.SUPER_ADMIN, ROLES.ADMIN, ROLES.DIRECCION, ROLES.ANALISTA, ROLES.DEPENDENCIA],
  
  // C3
  VIEW_PENDIENTES_C3: [ROLES.VALIDADOR_C3],
  VALIDATE_C3: [ROLES.VALIDADOR_C3],
  VIEW_HISTORIAL_C3: [ROLES.VALIDADOR_C3],
  VIEW_RECHAZOS_C3: [ROLES.SUPER_ADMIN, ROLES.ADMIN, ROLES.DIRECCION, ROLES.ANALISTA],

  // Citas biométricas
  VIEW_CITAS: [ROLES.SUPER_ADMIN, ROLES.ADMIN, ROLES.ANALISTA],

  // Finalizados
  VIEW_FINALIZADOS: [ROLES.SUPER_ADMIN, ROLES.ADMIN, ROLES.DIRECCION, ROLES.ANALISTA],
